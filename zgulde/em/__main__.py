...
def prev_and_next(xs):
    ...
    return zip(it.chain([None], prevs),
               items,
               it.chain(it.islice(nexts, 1, None), [None]))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--show-defaults', action='store_true', help='show defaults for each file extension and exit')
